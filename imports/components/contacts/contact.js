...
class TodosListCtrl {
  constructor($scope, $mdDialog) {
      ...
      vm.useContact = function(contact) {
          //this.selectedContact = contact;
          vm.onSelectContactChange({$value: {selectedContact: contact}})
          vm.searchResults = [];
      }
...
export default angular.module('contact', [
  ...
  .component('contact', {
    templateUrl: 'imports/components/contacts/contact.html'
    ,bindings: {
        selectedContact: '<'
        ,onSelectContactChange: '&'
    }
    ,controller: ['$scope', '$mdDialog', TodosListCtrl]
